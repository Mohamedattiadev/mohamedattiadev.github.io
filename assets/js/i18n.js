...
const DICTS = {
  en: {
    ...
    "work.card.fork":       "Fork",
    "work.card.fork_t":     "A fork of someone else's project, not written from scratch",
  ...
  tr: {
    ...
    "work.card.fork":       "Fork",
    "work.card.fork_t":     "Başkasının projesinin bir fork'u, sıfırdan yazılmadı",
  ...
  ar: {
    ...
    "work.card.fork":       "متفرّع",
    "work.card.fork_t":     "نسخة متفرّعة من مشروع شخص آخر، ليست مكتوبة من الصفر",
